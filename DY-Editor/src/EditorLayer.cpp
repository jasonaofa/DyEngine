...
namespace DyEngine {
	...
	void EditorLayer::OnAttach()
	{
		...
		DyEngine::FramebufferSpecification fbSpec;
		fbSpec.Width = 1280;
		fbSpec.Height = 720;
		m_Framebuffer = DyEngine::Framebuffer::Create(fbSpec);
	}
	...
	void EditorLayer::OnUpdate(DyEngine::Timestep ts)
	{
		DY_PROFILE_FUNCTION();
		...
		DY_PROFILE_FUNCTION();
			...
			if (ImGui::BeginMenuBar())
			{
				if (ImGui::BeginMenu("File"))
				{
					...
					if (ImGui::MenuItem("Exit")) DyEngine::Application::Get().Close();
					ImGui::EndMenu();
				}
