...
namespace DyEngine
{
	...
	DyEngine::Ref<DyEngine::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	DyEngine::Ref<DyEngine::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	DyEngine::Ref<DyEngine::Shader> ShaderLibrary::Get(const std::string& name)
	{
